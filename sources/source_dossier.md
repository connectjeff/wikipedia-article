...
| S8, SCH1, PESCBOARD2011, PESC2011, NCES2011, PESC2012, NCES2013, PESCNEWS2013, FAW1, ERUG1, PESC2016, ACEL1 | 2008-2017 | PESC / Fortnightly Mailing / NCES / StudyLib | Awards, board listing, PESC-hosted briefing, Data Summit programs, STATS-DC and MIS agendas, PESC publication, Functional Acknowledgment source lead, ERUG call notes, and implementation guide | Organizational award list, independent blog/guest contribution, conference programs, government conference agendas, organizational publication, document mirror/source lead, call notes, implementation guide | Mixed | Verified except FAW1, which is blocked/source lead only; PDFs/HTML/images/text extracted where applicable | Minor to moderate for narrow professional-context facts | Low to Medium | PESC board, ConnectEDU, standards-based student-record exchange, data standards, MyData/MyDataButton, ERUG, Eduventures ePortfolio research, award, and contributor context if retained |
...
- The StudyLib Functional Acknowledgment source lead is locally blocked by Cloudflare. It should remain unverified until the underlying document is reviewed directly.
...
Assessment: organizational/event evidence, weak for notability but acceptable for verifying narrow PESC, ConnectEDU, data-standards, MyData/MyDataButton, ERUG, Eduventures ePortfolio research, service-award, and implementation-guide contributor facts. NCES2013 is the cleanest direct source connecting Alderson to a MyDataButton session in a government conference agenda; PESCNEWS2013 adds a direct PESC publication listing for Alderson, ConnectEDU, and MyData. Neither is in-depth independent biographical coverage. FAW1 is source-lead only until browser/manual review confirms the underlying Functional Acknowledgment document.
