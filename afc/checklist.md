# AfC Readiness Checklist

- [x] Source dossier created in Excel format: `dossier/source_dossier.xlsx`
- [x] CSV companion created: `dossier/source_dossier.csv`
- [x] Human-readable source review created: `sources/source_dossier.md`
- [x] Reviewed sources saved under `data/`
...
- [x] Education and military-service claims reviewed against public source support; private transcripts and DD214 are not used as article citations.
