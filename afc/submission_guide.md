# AfC Submission Guide

Purpose: use the materials in this project to create `Draft:Jeffrey Alderson` on Wikipedia and submit it through Articles for Creation with a clear conflict-of-interest disclosure.

## Before You Start

Use these project files:

- `drafts/article_draft.wikitext` - the article text to paste into the Wikipedia draft editor.
- `afc/submission_note.md` - COI disclosure text for your user page, draft talk page, and AfC submission comment.
- `afc/checklist.md` - final pre-submission checklist.
- `sources/source_dossier.md` - source-quality notes for your own review.
- `dossier/source_dossier.xlsx` - spreadsheet dossier for internal review.
...
- Your user page: `https://en.wikipedia.org/wiki/Special:MyPage`
- Article Wizard: `https://en.wikipedia.org/wiki/Wikipedia:Article_wizard`
- Articles for Creation overview: `https://en.wikipedia.org/wiki/Wikipedia:Articles_for_creation`
- Draft page to create: `https://en.wikipedia.org/wiki/Draft:Jeffrey_Alderson`
- Draft talk page for COI disclosure: `https://en.wikipedia.org/wiki/Draft_talk:Jeffrey_Alderson`
...
2. Add a COI disclosure.
   - Go to your user page: `https://en.wikipedia.org/wiki/Special:MyPage`.
   - Add the suggested user-page disclosure from `afc/submission_note.md`:

```wikitext
{{UserboxCOI|1=Jeffrey Alderson}}
```
...
```text
Creating COI-disclosed AfC draft based on published sources
```

6. Add a draft talk-page COI disclosure.
   - Go to `https://en.wikipedia.org/wiki/Draft_talk:Jeffrey_Alderson`.
   - Add the suggested draft talk-page disclosure from `afc/submission_note.md`:
...
7. Submit through Articles for Creation.
   - Return to `https://en.wikipedia.org/wiki/Draft:Jeffrey_Alderson`.
   - If `{{subst:submit}}` is already at the top of the draft, save the page with that template in place.
   - If it is not present, add it at the top of the draft and save.
   - In the edit summary or submission comment, use:

```text
Submitting through Articles for Creation. I am the subject of this draft and have disclosed my conflict of interest.
```
...
- The article draft is copied from `drafts/article_draft.wikitext`.
